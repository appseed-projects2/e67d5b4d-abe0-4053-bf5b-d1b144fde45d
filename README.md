...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-05-14 23:46`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e67d5b4d-abe0-4053-bf5b-d1b144fde45d.git
$ cd e67d5b4d-abe0-4053-bf5b-d1b144fde45d
```
